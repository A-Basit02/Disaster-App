            ...
            {({ handleChange, handleSubmit, values, errors, touched }) => (
              <VStack space={3} w="full" px={4}>
                <Box>
                  ...
                  <SafeInput value={values.shelter_name} onChangeText={handleChange('shelter_name')} />
                ...
                <Box>
                  ...
                  <SafeInput value={values.managed_by} onChangeText={handleChange('managed_by')} />
                </Box>
                <HStack space={3}>
                  <Box flex={1}>
                    <Text color="gray.400" mb={1}>
                    ...
                    <SafeInput value={values.street_no} onChangeText={handleChange('street_no')} />
                  </Box>
                  <Box flex={2}>
                    <Text color="gray.400" mb={1}>
                      Street name
                    </Text>
                    <SafeInput value={values.street_name} onChangeText={handleChange('street_name')} />
                  </Box>
                </HStack>
                <Box>
                  <Text color="gray.400" mb={1}>
