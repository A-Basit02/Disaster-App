...
import { SafeInput } from '@/src/components/ui/SafeInput';
            ...
            {({ handleChange, handleSubmit, values, errors, touched }) => (
              <VStack space={3} w="full" px={4}>
                <Box>
                  ...
                  <SafeInput value={values.resource_type} onChangeText={handleChange('resource_type')} />
                ...
                <Box>
                  ...
                  <SafeInput value={values.resource_desc} onChangeText={handleChange('resource_desc')} />
                </Box>
                <Box>
                  <Text color="gray.400" mb={1}>
            ...
            {({ handleChange, handleSubmit, values, errors, touched }) => (
              <VStack space={3} w="full" px={4}>
                ...
                <Box>
                  ...
                  <SafeInput value={values.assigned_to} onChangeText={handleChange('assigned_to')} keyboardType="numeric" />
                </Box>
                <Box>
                  <Text color="gray.400" mb={1}>
                    Remarks
                  </Text>
                  <SafeInput value={values.remarks} onChangeText={handleChange('remarks')} />
                </Box>
                <Button mt={2} onPress={() => handleSubmit()}>
                  Dispatch
                </Button>
